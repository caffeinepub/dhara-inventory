...
import type { Customer as _Customer, OrderStatus as _OrderStatus, OrderType as _OrderType, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createOrder(arg0: bigint, arg1: Array<bigint>, arg2: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getOrder(arg0: bigint): Promise<OrderType> {
        if (this.processError) {
            try {
                ...
                return from_candid_OrderType_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OrderType>): Array<OrderType> {
    return value.map((x)=>from_candid_OrderType_n4(_uploadFile, _downloadFile, x));
}
